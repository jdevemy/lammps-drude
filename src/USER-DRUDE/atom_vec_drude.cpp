...
void AtomVecDrude::grow(int n)
{
  ...
  memory->grow(atom->drudeid,nmax,"atom:drudeid");
...
void AtomVecDrude::copy(int i, int j, int delflag)
{
  int k;
...
int AtomVecDrude::pack_comm(int n, int *list, double *buf,
...
int AtomVecDrude::pack_comm_vel(int n, int *list, double *buf,
                               int pbc_flag, int *pbc)
{
  int i,j,m;
...
void AtomVecDrude::unpack_comm(int n, int first, double *buf)
{
  int i,m,last;
...
void AtomVecDrude::unpack_comm_vel(int n, int first, double *buf)
{
  int i,m,last;
...
int AtomVecDrude::pack_reverse(int n, int first, double *buf)
{
  int i,m,last;
...
void AtomVecDrude::unpack_reverse(int n, int *list, double *buf)
{
  int i,j,m;
...
int AtomVecDrude::pack_border(int n, int *list, double *buf,
                             int pbc_flag, int *pbc)
{
  int i,j,m;
  double dx,dy,dz;
...
int AtomVecDrude::pack_border_vel(int n, int *list, double *buf,
                                 int pbc_flag, int *pbc)
{
  int i,j,m;
  double dx,dy,dz,dvx,dvy,dvz;
...
int AtomVecDrude::pack_border_hybrid(int n, int *list, double *buf)
{
  int i,j,m;
...
void AtomVecDrude::unpack_border(int n, int first, double *buf)
{
  int i,m,last;
...
void AtomVecDrude::unpack_border_vel(int n, int first, double *buf)
{
  int i,m,last;
...
int AtomVecDrude::unpack_border_hybrid(int n, int first, double *buf)
{
  int i,m,last;
...
int AtomVecDrude::pack_exchange(int i, double *buf)
{
  int k;
...
int AtomVecDrude::unpack_exchange(double *buf)
{
  int k;
...
int AtomVecDrude::pack_restart(int i, double *buf)
{
  int k;
...
int AtomVecDrude::unpack_restart(double *buf)
{
  int k;
...
void AtomVecDrude::create_atom(int itype, double *coord)
{
  int nlocal = atom->nlocal;
  if (nlocal == nmax) grow(0);
...
void AtomVecDrude::data_atom(double *coord, imageint imagetmp, char **values)
{
  int nlocal = atom->nlocal;
  if (nlocal == nmax) grow(0);
...
int AtomVecDrude::data_atom_hybrid(int nlocal, char **values)
{
...
void AtomVecDrude::pack_data(double **buf)
{
  int nlocal = atom->nlocal;
...
int AtomVecDrude::pack_data_hybrid(int i, double *buf)
{
...
void AtomVecDrude::write_data(FILE *fp, int n, double **buf)
{
  for (int i = 0; i < n; i++)
...
int AtomVecDrude::write_data_hybrid(FILE *fp, double *buf)
{
...
bigint AtomVecDrude::memory_usage()
{
  bigint bytes = 0;
...
void AtomVecDrude::set_drudetypes(const char *str)
{
  ...
  if (idtype < 0 || idtype > 2)
    error->all(FLERR,"Invalid Drude type for Drude type set");

  if (itype < 1 || itype > atom->ntypes)
    error->all(FLERR,"Invalid type for Drude type set");

  atom->drudetype[itype] = idtype;
}
